package com.appero.streamradio.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.appero.streamradio.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.appero.streamradio.repository.UserRepository.USERS_BY_EMAIL_CACHE);
